...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\rpassword_hash\x18\x01 \x01(\tR\fpasswordHash\"\x16\n" +
	"\x14ValidateTokenRequest\"2\n" +
	...
	"\x14GeneratePasswordHash\x12!.auth.GeneratePasswordHashRequest\x1a\".auth.GeneratePasswordHashResponse\x12H\n" +
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*LogoutAllRequest)(nil),             // 15: auth.LogoutAllRequest
	(*LogoutAllResponse)(nil),            // 16: auth.LogoutAllResponse
	(*ChangePasswordRequest)(nil),        // 17: auth.ChangePasswordRequest
	(*ChangePasswordResponse)(nil),       // 18: auth.ChangePasswordResponse
	(*ForceChangePasswordRequest)(nil),   // 19: auth.ForceChangePasswordRequest
	(*ForceChangePasswordResponse)(nil),  // 20: auth.ForceChangePasswordResponse
	(*ChangeEmailRequest)(nil),           // 21: auth.ChangeEmailRequest
	(*ChangeEmailResponse)(nil),          // 22: auth.ChangeEmailResponse
	(*ForceChangeEmailRequest)(nil),      // 23: auth.ForceChangeEmailRequest
	(*ForceChangeEmailResponse)(nil),     // 24: auth.ForceChangeEmailResponse
}
var file_auth_auth_proto_depIdxs = []int32{
	...
	7,  // 4: auth.Auth.CheckPassword:input_type -> auth.CheckPasswordRequest
	9,  // 5: auth.Auth.GeneratePasswordHash:input_type -> auth.GeneratePasswordHashRequest
	11, // 6: auth.Auth.ValidateToken:input_type -> auth.ValidateTokenRequest
	13, // 7: auth.Auth.Logout:input_type -> auth.LogoutRequest
	15, // 8: auth.Auth.LogoutAll:input_type -> auth.LogoutAllRequest
	17, // 9: auth.Auth.ChangePassword:input_type -> auth.ChangePasswordRequest
	19, // 10: auth.Auth.ForceChangePassword:input_type -> auth.ForceChangePasswordRequest
	21, // 11: auth.Auth.ChangeEmail:input_type -> auth.ChangeEmailRequest
	23, // 12: auth.Auth.ForceChangeEmail:input_type -> auth.ForceChangeEmailRequest
	2,  // 13: auth.Auth.Login:output_type -> auth.LoginResponse
	4,  // 14: auth.Auth.Register:output_type -> auth.RegisterResponse
	6,  // 15: auth.Auth.RefreshTokens:output_type -> auth.RefreshTokensResponse
	8,  // 16: auth.Auth.CheckPassword:output_type -> auth.CheckPasswordResponse
	10, // 17: auth.Auth.GeneratePasswordHash:output_type -> auth.GeneratePasswordHashResponse
	12, // 18: auth.Auth.ValidateToken:output_type -> auth.ValidateTokenResponse
	14, // 19: auth.Auth.Logout:output_type -> auth.LogoutResponse
	16, // 20: auth.Auth.LogoutAll:output_type -> auth.LogoutAllResponse
	18, // 21: auth.Auth.ChangePassword:output_type -> auth.ChangePasswordResponse
	20, // 22: auth.Auth.ForceChangePassword:output_type -> auth.ForceChangePasswordResponse
	22, // 23: auth.Auth.ChangeEmail:output_type -> auth.ChangeEmailResponse
	24, // 24: auth.Auth.ForceChangeEmail:output_type -> auth.ForceChangeEmailResponse
