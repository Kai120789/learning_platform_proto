...
const (
	...
	Auth_ForceChangeEmail_FullMethodName     = "/auth.Auth/ForceChangeEmail"
)
...
type AuthClient interface {
	...
	ForceChangeEmail(ctx context.Context, in *ForceChangeEmailRequest, opts ...grpc.CallOption) (*ForceChangeEmailResponse, error)
}
...
func (c *authClient) CheckPassword(ctx context.Context, in *CheckPasswordRequest, opts ...grpc.CallOption) (*CheckPasswordResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckPasswordResponse)
	err := c.cc.Invoke(ctx, Auth_CheckPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) GeneratePasswordHash(ctx context.Context, in *GeneratePasswordHashRequest, opts ...grpc.CallOption) (*GeneratePasswordHashResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authClient) ForceChangeEmail(ctx context.Context, in *ForceChangeEmailRequest, opts ...grpc.CallOption) (*ForceChangeEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ForceChangeEmailResponse)
	err := c.cc.Invoke(ctx, Auth_ForceChangeEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	ForceChangeEmail(context.Context, *ForceChangeEmailRequest) (*ForceChangeEmailResponse, error)
...
func (UnimplementedAuthServer) CheckPassword(context.Context, *CheckPasswordRequest) (*CheckPasswordResponse, error) {
...
func (UnimplementedAuthServer) ForceChangeEmail(context.Context, *ForceChangeEmailRequest) (*ForceChangeEmailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForceChangeEmail not implemented")
}
...
func _Auth_CheckPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckPasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).CheckPassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_CheckPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckPassword(ctx, req.(*CheckPasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_GeneratePasswordHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GeneratePasswordHashRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).GeneratePasswordHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_GeneratePasswordHash_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_ForceChangeEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ForceChangeEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).ForceChangeEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_ForceChangeEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).ForceChangeEmail(ctx, req.(*ForceChangeEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ForceChangeEmail",
			Handler:    _Auth_ForceChangeEmail_Handler,
		},
	},
